...
#geri dönme ihtimalimize karsı kopyalarını alalım
...
check_df(df_control)
#Quantiles sıcrama olmadıgı için aykırı değer yoktur yorumunu da yapabiliriz
...
print('Test Stat = %.4f, p-value = %.4f' % (test_stat, pvalue))
# p-value = 0.3493 HO reddedilemez H0 hatırlarsak Kontrol grubu ve test grubu satın alma ortalamaları arasında
...
#ilk önce iki gruba da normallik testi uyguladık. iki grubun da normal dagılıma uydugu gözlemlendiği için
#ikinci varsayıma geçerek varyansın homojenliği incelenmiştir. Varyanslar da homojen cıktıgından
#"Bağımsız iki örneklem T testi" uygulanmıstır. Uygulama sonucunda p değerinin 0.05 ten büyük oldugu gözlemlenmiştir.
#ve H0 hipotezi reddedilememiştir.

# Adım 2: Elde ettiğiniz test sonuçlarına göre müşteriye tavsiyede bulununuz.

#satın alma anlamında anlamlı bir fark olmadıgından müşteri iki yöntemden birini seçebilir fakat burada diğer
#istatistiklerdeki farklılıklar da önem arz edecektir. Tıklanma, etkileşim, kazanx ve dönüşüm oranlarındaki
#farklılıklar değerlendirilip hangi yöntemin daha kazanclı oldugu tespit edilebilir. özellikle facebook a
#tıklama basına para ödendiği için hangi yöntemde tıklanma oranının daha düşük oldugu tespit edilip ve CTR(click
# through rate- tıklama oranı) oranına bakılabilir.
#iki grup gözlenmeye devam edilir.  Şuan için yapacagımız durum ilk ortalamaki farklılıklar sans eseri
# gelmiş yorumunu yapabiliriz.
